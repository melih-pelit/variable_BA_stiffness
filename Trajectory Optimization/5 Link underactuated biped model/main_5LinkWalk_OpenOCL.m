...
% load("results\5LinkWalkingOpenOCL2023-04-04-09-29.mat");
load("results\5LinkWalkingOpenOCL2023-04-05-22-03.mat");
...
sh.addState('th2', 'lb', 0, 'ub', deg2rad(22.5));
...
% ch.add(p.l1*sin(x.th1) + p.l2*sin(x.th1+x.th2) + p.l5*sin(x.th1+x.th2+x.th5), '>=', 1.1);
